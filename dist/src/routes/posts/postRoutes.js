...
exports.postsRoutes
    ...
    //     res.sendStatus(404)
    // })
    .post('/', authMiddleware_1.authMiddleware, postValidator_1.titleValidator, postValidator_1.shortDescriptionValidator, postValidator_1.contentValidator, (req, res) => {
