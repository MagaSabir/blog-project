...
exports.blogRoutes = (0, express_1.Router)()
    ...
    res.status(200).send(yield blogs_service_1.blogsService.findBlogs());
}))
    ...
    .put('/:id', authMiddleware_1.authMiddleware, blog_validations_1.websiteUrlValidator, blog_validations_1.descriptionValidator, blog_validations_1.websiteUrlValidator, blog_validations_1.nameValidator, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, db_1.errorsArray)(req);
    if (errors.length) {
        res.status(400).send({ errorsMessages: errors });
        return;
